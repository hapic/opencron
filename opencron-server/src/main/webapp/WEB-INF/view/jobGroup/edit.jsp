...
<head>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if(name==$("#oldGroupName").val()){//如果名称相等就不在判断
                return true;
            }
            if (!name) {
        ...
        $(document).ready(function () {
            ...
            $("#groupName").blur(function () {
                if($("#groupName").val()==$("#oldGroupName").val()){//如果名称相等就不在判断
                    return true;
                }
                if (!$("#groupName").val()) {
                    $("#checkName").html("<font color='red'>" + '<i class="glyphicon glyphicon-remove-sign"></i>&nbsp;请填写组名称' + "</font>");
...
<section id="content" class="container">
    ...
    <ol class="breadcrumb hidden-xs">
        ...
        <li><a href=""> 编辑作业组</a></li>
    </ol>
    <h4 class="page-title"><i aria-hidden="true" class="fa fa-plus"></i>&nbsp;编辑作业组</h4>
    ...
    <div class="block-area" id="basic">
        <div class="tile p-15">
            <form class="form-horizontal" role="form" id="agent" action="${contextPath}/jobGroup/save.do" method="post" onsubmit="return save()"></br>
                ...
                <input type="hidden" id="oldGroupName" value="${group.name}">

                <div class="form-group">
                    <label for="groupName" class="col-lab control-label"><i class="glyphicon glyphicon-leaf"></i>&nbsp;&nbsp;作业组名称：</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control input-sm" id="groupName" name="name" value="${group.name}" />
                        <span class="tips" id="checkName"><b>*&nbsp;</b>作业组名称必填</span>
                    </div>
                </div>
                <br>
