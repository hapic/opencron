...
<section id="content" class="container">
    ...
    <ol class="breadcrumb hidden-xs">
        ...
        <li><a href="">作业管理</a></li>
        <li><a href=""> 作业组列表</a></li>
    </ol>
    <h4 class="page-title"><i aria-hidden="true" class="fa fa-group"></i>&nbsp;作业组管理</h4>
    <div class="block-area" id="defaultStyle">
        ...
        <div style="float: right;margin-top: -10px">
            <a href="${contextPath}/jobGroup/add.htm?csrf=${csrf}" class="btn btn-sm m-t-10" style="margin-left: 50px;margin-bottom: 8px"><i class="icon">&#61943;</i>添加</a>
        </div>
            ...
            <tbody>
                <c:forEach var="g" items="${pageBean.result}" varStatus="index">
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="${contextPath}/jobGroup/edit/${g.id}.htm?csrf=${csrf}" title="编辑">
                                    <i class="glyphicon glyphicon-pencil"></i>
                                </a>&nbsp;&nbsp;
                                <a href="${contextPath}/job/view.htm?csrf=${csrf}&groupId=${g.id}" title="查看任务列表">
